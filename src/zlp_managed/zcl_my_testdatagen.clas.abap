CLASS zcl_my_testdatagen DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_my_testdatagen IMPLEMENTATION.
METHOD if_oo_adt_classrun~main.
 ...
 METHOD create_truck_driver_data.
    ...
    INSERT zmy_truckdriver FROM TABLE @( VALUE #(
    (
  ...
  METHOD create_truck_tracking_data.
    ...
    INSERT zmy_trucktrack FROM TABLE @( VALUE #(
    (
    mandt = '100' truckregnum = 'TRUCK001' truckmake = 'Volvo'
    truckpuc = 'PUC12345' lastchanged = current_timestamp
    createdby = sy-uname changedby = sy-uname
    )
    (
    mandt = '100' truckregnum = 'TRUCK002' truckmake = 'Scania'
    truckpuc = 'PUC67890' lastchanged = current_timestamp
    createdby = sy-uname changedby = sy-uname
    )
    (
    mandt = '100' truckregnum = 'TRUCK003' truckmake = 'Mercedes'
